...
message = tk.Label(window, text="Smart-Campus-Security-System" ,bg="white"  ,fg="black"  ,width=100  ,height=3,font=('times', 30, 'italic bold underline')) 
...
txt2.place(x=450, y=300)

lbl3 = tk.Label(window, text="VALIDATION : ",width=55  ,fg="black"  ,bg="white"  ,height=2 ,font=('times', 15, ' bold underline ')) 
lbl3.place(x=900, y=200)

message = tk.Label(window, text="" ,bg="white"  ,fg="black"  ,width=30  ,height=2, activebackground = "white" ,font=('times', 15, ' bold ')) 
message.place(x=1000, y=300)

lbl3 = tk.Label(window, text="Information : ",width=70  ,fg="black"  ,bg="white"  ,height=2 ,font=('times', 20, ' bold  underline')) 
lbl3.place(x=30, y=650)


message2 = tk.Label(window, text="" ,fg="black"   ,bg="white",activeforeground = "green",width=65  ,height=6  ,font=('times', 15, ' bold ')) 
